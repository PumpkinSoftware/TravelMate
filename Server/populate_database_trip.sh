...
curl -H "Content-Type: application/json" -X POST -d '{"name":"Road To Milan","description":"best travel to milan","departure":"rome","destination":"milan","budget":"123.50","startDate":"04/04/2019","endDate":"04/10/2019","pets":"true","maxPartecipant":"10"}' http://localhost:8095/trip/newTrip

echo -e ""

curl -H "Content-Type: application/json" -X POST -d '{"name":"bourem is bourem","description":"who is bourem","departure":"milan","destination":"bourem","budget":"450.20","startDate":"10/12/2019","endDate":"10/24/2019","pets":"false","maxPartecipant":"9"}' http://localhost:8095/trip/newTrip
...
curl -H "Content-Type: application/json" -X POST -d '{"name":"brazil, i want you!","description":"amazing brazil","departure":"bari","destination":"fortaleza","budget":"543.50","startDate":"05/01/2019","endDate":"06/20/2019","pets":"false","maxPartecipant":"2"}' http://localhost:8095/trip/newTrip

echo -e ""

curl -H "Content-Type: application/json" -X POST -d '{"name":"tea time","description":"london everywhere","departure":"paris","destination":"london","budget":"234.00","startDate":"03/01/2019","endDate":"03/10/2019","pets":"true","maxPartecipant":"10"}' http://localhost:8095/trip/newTrip

echo -e ""

curl -H "Content-Type: application/json" -X POST -d '{"name":"California, i love you","description":"california in 360°","departure":"rome","destination":"san francisco","budget":"1543.50","startDate":"04/15/2019","endDate":"05/20/2019","pets":"true","maxPartecipant":"10"}' http://localhost:8095/trip/newTrip

echo -e ""

curl -H "Content-Type: application/json" -X POST -d '{"name":"lourdes, we are coming!","description":"god is with us","departure":"naples","destination":"lourdes","budget":"143.50","startDate":"07/23/2019","endDate":"07/27/2019","pets":"false","maxPartecipant":"20"}' http://localhost:8095/trip/newTrip
