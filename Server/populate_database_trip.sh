...
curl -H "Content-Type: application/json" -X POST -d '{
  ...
  "endDate": "04/05/2019",
  "image": "https://firebasestorage.googleapis.com/v0/b/travelmate-ee239.appspot.com/o/tripImage%2Fe289308383.jpeg?alt=media&token=f4eb9a6f-cb77-40a2-83b0-37256caa4821",
  "maxPartecipant": "16",
...
curl -H "Content-Type: application/json" -X POST -d '{
  ...
  "destination": "bologna",
  "endDate": "03/22/2019",
  "image": "https://firebasestorage.googleapis.com/v0/b/travelmate-ee239.appspot.com/o/tripImage%2Fhttps___cdn.evbuc.com_images_52375141_241612882443_1_original.jpg?alt=media&token=4f500d9d-2c08-4faa-b240-b8a3131bdc5c",
  "maxPartecipant": 7,
